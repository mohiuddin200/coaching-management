...
console.log(`🔍 Debugging student deletion for ID: ${TEST_STUDENT_ID}`);
console.log('='.repeat(50));

async function debugStudentDeletion() {
  try {
    // Step 1: Check debug endpoint
    console.log('\n📊 Step 1: Analyzing student data...');
    ...
    console.log(`   Class: ${debugData.student.class}`);
    ...
    console.log('\n📋 Step 3: Checking remaining enrollments...');
    ...
    console.log('\n🗑️  Step 4: Attempting soft delete...');
    ...
    if (deleteResponse.ok) {
      ...
      if (deleteResult.error && deleteResult.error.includes('related records')) {
        console.log('\n🔍 Analysis: Failed due to related records');
        ...
        console.log('\n🔍 Analysis: Failed during cleanup phase');
