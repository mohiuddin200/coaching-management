...
export async function DELETE(
  ...
  try {
    ...
    console.log(`[DEBUG] Checking related records for student ${id}...`);
    const relatedRecords = await getStudentRelatedRecords(id);
    console.log(`[DEBUG] Related records found:`, relatedRecords);
    
    // If there are auto-generated enrollments, clean them up first
    if (relatedRecords.autoGeneratedEnrollments > 0) {
      console.log(`[DEBUG] Found ${relatedRecords.autoGeneratedEnrollments} auto-generated enrollments, cleaning up...`);
      ...
      if (!cleanupResult.success) {
        console.log(`[DEBUG] Cleanup failed:`, cleanupResult.error);
      ...
      console.log(`[DEBUG] Cleanup successful, deleted ${cleanupResult.deletedCount} enrollments`);
      ...
      console.log(`[DEBUG] Refreshing related records after cleanup...`);
      const updatedRelatedRecords = await getStudentRelatedRecords(id);
      console.log(`[DEBUG] Updated related records:`, updatedRelatedRecords);
    ...
    console.log(`[DEBUG] Blocking records check:`, {
      enrollments: relatedRecords.enrollments,
    ...
    console.log(`[DEBUG] No blocking records found, proceeding with soft delete...`);
    // Perform soft delete
    ...
    console.log(`[DEBUG] Soft delete result:`, softDeleteResult);

    if (!softDeleteResult.success) {
      console.log(`[DEBUG] Soft delete failed:`, softDeleteResult.message);
      return NextResponse.json(
    ...
    console.log(`[DEBUG] Soft delete successful`);
