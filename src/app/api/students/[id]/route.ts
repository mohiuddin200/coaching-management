  ...
  try {
    ...
    if (cascade) {
      ...
      if (relatedRecords.attendances > 0) {
        ...
        logDeletionAttempt("student", id, "success", {
          deletedRecords: "attendances",
          count: relatedRecords.attendances,
        });
      }
      ...
      if (relatedRecords.enrollments > 0) {
        ...
        logDeletionAttempt("student", id, "success", {
          deletedRecords: "enrollments",
          count: relatedRecords.enrollments,
        });
      }
      ...
      if (relatedRecords.payments > 0) {
        ...
        logDeletionAttempt("student", id, "success", {
          deletedRecords: "payments",
          count: relatedRecords.payments,
        });
      }
